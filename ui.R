    ...
    dashboardBody(
        ...
        tabItems(
            ...
            tabItem(tabName="mon",
                ...
                fluidRow(
                    box(width=9, height=600, title="Tracking", status="primary", solidHeader=T,
                        p(),
                        p(),
                        p(),
#                        column(9,
                            dygraphOutput("serie", height=530)
                        ),
#                        column(3,
                    box(width=3, height=600, title="Tracking", status="primary", solidHeader=T,                        
                            h4("Instructions:"),
                            ...
                            br(),
                            HTML("<p><b>Since February 17th the confirmed infected definition used by the chinese government has changed. That's why a conspicuous increase in the total number of infected cases can be observed in comparisson with the quantities reported before.</b></p>")
#                        )
                    ),
